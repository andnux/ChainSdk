package top.andnux.chain.eos.ecc;

import java.math.BigInteger;
import java.nio.ByteBuffer;

import top.andnux.chain.eos.api.vo.transaction.push.TxSign;
import top.andnux.chain.eos.utils.Base58;
import top.andnux.chain.eos.utils.ByteUtils;
import top.andnux.chain.eos.utils.EException;
import top.andnux.chain.eos.utils.Hex;
import top.andnux.chain.eos.utils.ObjectUtils;
import top.andnux.chain.eos.utils.Ripemd160;
import top.andnux.chain.eos.utils.Sha;
...
public class EccTool {
	...
	public static String signTransaction(String privateKey, TxSign push) {
		// tx
		top.andnux.chain.eos.utils.ByteBuffer  bf = new top.andnux.chain.eos.utils.ByteBuffer ();
